...
export default (x, y, z) => {
  ...
  return (
    !opened ?
      ...
      :
      <Html distanceFactor={10} position={[x , y + 0.8, z - 10]} rotation={[-0.1, 0, 0]} transform>
        <div className="container">
          <div className='bg-[#9e2424] w-72 rounded-md border-4 p-2 border-[#732402]'>
            ...
            {/* <div className='flex justify-evenly mt-2'>
              <p className="text-white bg-[#546d26] text-sm inline border-2 rounded-md"><button className='px-1' onClick={onNext}>NEXT</button></p>
              <p className="text-white bg-[#e23939] text-sm inline border-2 rounded-md"><button className='px-1' onClick={onClose}>CLOSE</button></p>
            </div> */}
          </div>
